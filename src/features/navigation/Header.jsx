...
const Header = () => {
  ...
  // State to track contact form visibility
    ...
    >
      ...
      >
          ...
          <div
            className="h-10 w-10 rounded-xl
                 bg-gradient-to-r from-gray-500 to-gray-100
                  ...
                  text-cyan-600 front-bold text-xl mr-3"
          >
            M
          </div>
        ...
        <nav className="lg:flex hidden space-x-8">
          {["Home", "About", "Project", "Certificates", "Contact"].map(
            (item, index) => (
              <motion.a
                key={item}
                ...
                className="relative text-gray-800 dark:text-gray-200
                    hover:text-cyan-600 dark:hover:text-cyan-400 font-mono text-sm tracking-wide
              ...
              >
                ...
                <span
                  className="absolute bottom-0 left-0 w-0 h-0.5
                         bg-cyan-600 group-hover:w-full transition-all
                        "
                ></span>
              </motion.a>
            )
        ...
        <div className="md:flex hidden items-center space-x-4">
          <motion.a
            ...
            className="text-gray-700 dark:text-gray-300 hover:text-cyan-600
                dark:hover:text-cyan-400 transition-colors duration-300"
          ...
          <motion.button
            ...
            className="ml-4 px-4 py-2 rounded-xl bg-gradient-to-r
                from-gray-400 to-gray-100 text-blue-700 font-bold font-mono text-sm tracking-wide
                hover:from-blue-700 hover:to-cyan-700 hover:text-white
      ...
      >
        ...
        >
          <div className="flex space-x-5">
            ...
            <a href="https://linkedin.com/in/mihirnetam-08m" target="_blank" rel="noopener noreferrer">
          ...
          <button
            ...
            className="mt-4 block w-full px-4 py-2 rounded-lg
                            bg-gradient-to-r from-blue-600 to-blue-400 font-bold font-mono text-sm tracking-wide text-white"
          >
            Contact Me
          </button>
        </div>
              ...
              <form ref={form} onSubmit={sendEmail} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-600
                             ...
                             focus:border-blue-500 bg-gray-700 text-white"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2 border border-gray-600
                            rounded-lg focus:ring-2 focus:ring-blue-500
                            focus:border-blue-500 bg-gray-700 text-white resize-none"
                  ></textarea>
                </div>
